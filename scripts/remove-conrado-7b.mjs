...
console.log('🗑️  ELIMINANDO TODAS LAS CLASES DE 7B - CONRADO DE LEÓN\n');
...
// Buscar todas las asignaciones de Conrado con 7B
...
if (assignments7B.length === 0) {
  console.log('✓ No hay clases de 7B para eliminar\n');
  await p.$disconnect();
  process.exit(0);
}
...
console.log('📅 HORARIO ACTUALIZADO DE CONRADO DE LEÓN:\n');
